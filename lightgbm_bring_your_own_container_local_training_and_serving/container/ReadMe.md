...
This example shows how to package an algorithm for use with SageMaker. We have chosen a simple [LightGBM][lightgbm] implementation of regression to illustrate the procedure.
...
* __lightgbm_regression__: The directory that contains the application to run in the container. See the next session for details about each of the files.
...
[lightgbm]: https://lightgbm.readthedocs.io/en/latest/ "LightGBM’s documentation"
