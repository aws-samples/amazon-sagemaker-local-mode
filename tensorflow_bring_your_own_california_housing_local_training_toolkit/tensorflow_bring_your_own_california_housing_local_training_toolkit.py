# This is a sample Python program that trains a BYOC TensorFlow model with sagemaker-training-toolkit.
...
#       docker build  -t sagemaker-tensorflow2-training-toolkit-local container/.
########################################################################################################################
...
def main():
    ...
    image = 'sagemaker-tensorflow2-training-toolkit-local'
