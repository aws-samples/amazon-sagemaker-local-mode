# This is a sample Python program that trains a simple scikit-learn Regressor tree model, and then performs inference.
...
#       docker build  -t sagemaker-scikit-learn-graviton-regressor-local container/.
########################################################################################################################
...
image = 'sagemaker-scikit-learn-graviton-regressor-local'
